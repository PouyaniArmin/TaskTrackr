...
<div class="row">
    <div class="col-6">
        <div class="container w-75 shadow p-3">
            <form method="post">
                <div class="mb-3">
                    <input type="username" name="username" placeholder="Username" class="form-control" id="InputUsername">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="password" name="confirmPassword" placeholder="Confirm Password" class="form-control" id="inputConfirmPassword">
                </div>
    ...
    <div class="col-6 w-25 p-4">
        <a href="<?php echo $google; ?>" class="d-flex align-items-center text-decoration-none shadow-lg">
            <i class="bi bi-google me-2 text-danger fs-4"></i> Create Account With Gmail
        </a>
    </div>
</div>